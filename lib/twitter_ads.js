    ...
    Sync(function() {
      ...
      while (totalBytesRead < totalBytes) {
        ...
        if (Array.isArray(requestResult)) {
          resp = requestResult[0];
          body = requestResult[1];
        }
        ...
        if (resp.statusCode === 201) finalLocation = constants.TON_API_HOST + self.config.ton_api_version + resp.headers.location.substring(1);
